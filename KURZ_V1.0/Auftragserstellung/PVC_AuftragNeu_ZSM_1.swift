...
class PVC_AuftragNeu_ZSM_1: UIPageViewController {
    ...
    private func newZusammenfassungViewController(nummer: Int) -> UIViewController {
        ...
        return UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "VC_AuftragNeu_ZSM_1_\(nummer)")
...
extension PVC_AuftragNeu_ZSM_1 : UIPageViewControllerDataSource {
